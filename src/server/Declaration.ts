...
export class Declaration {
    ...
    public getClass(name: string): DeclarationItem {
        return this.getItem('class', name, this.items);
    }

    private getItem(type: string, name: string, _items: DeclarationItem[]): DeclarationItem {
        _items = _.filter<DeclarationItem>(_items, (item: DeclarationItem) => item.type === type);
        var item = _.find<DeclarationItem>(_items, (item: DeclarationItem) => item.name === name);
        return item || _.find<DeclarationItem>(_items, (item: DeclarationItem) => this.getItem(type, name, item.members) !== undefined);
    }
}
...
export class ModelInfo {
    ...
    constructor(public type: any, declaration: Declaration) {
        ...
        this.properties = _<DeclarationItem>(modelDefinition.members || [])
